...
if(menu.a2 == true){
  if (menu.Menu_page == 3 & menu.Main_menu_inde1 == 2) {
   if(BlinkerTime > Time & BlinkerTime-Time > 100){
     Time = BlinkerTime;
     digitalWrite(LED_BUILTIN, HIGH);
     if (agreement == "0") { Switch_433.setProtocol(menu.a4); Switch_433.setPulseLength(menu.a3);Switch_433.setRepeatTransmit(4); Switch_433.send(Base.c_str()); }
     if (agreement == "1") { Switch_315.setProtocol(menu.a4); Switch_315.setPulseLength(menu.a3);Switch_433.setRepeatTransmit(4); Switch_315.send(Base.c_str()); }
     digitalWrite(LED_BUILTIN, LOW); 
         
  }
  menu.Power = true; 
 }else { menu.a2 = false; pinMode(LED_BUILTIN, OUTPUT);}
}
